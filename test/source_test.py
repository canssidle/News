...
class SourceTest(unittest.TestCase):
    ...
    def setup(self):
        ...
        """
        self.new_source = Source("Me","KBC","Test to see if Source is retrieved","TestUrl","The article itself")
    ...
    def test_init(self):
        ...
        """
        self.assertEqual(self.new_source.id,"Me")
        self.assertEqual(self.new_source.name,"KBC")
...
class ArticleTest(unittest.TestCase):
    ...
    def setup(self):
        ...
        Set up method that will run before every Test
        """
        self.new_article = Article("me","TestTitle","TestDescription","TestUrl","TestUrlToImage","TestPublishedAt","TestContent")
    ...
    def test_init(self):
        ...
        test_init case to test if the object is initialized properly
        """
        self.assertEqual(self.new_article.id,"me")
